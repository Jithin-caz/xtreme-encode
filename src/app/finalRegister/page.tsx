...
export default function FinalRegistration()
{
    ...
    return !loading?<section className=" bg-slate-950 p-10 py-8 pt-16 h-dvh text-purple-800">
        { isRegistered?
            <h1 className=" text-center  text-4xl font-semibold  text-purple-700">Registration complete</h1>:
            <h1 className=" text-2xl  text-purple-700 font-semibold">Once registered changes cannot be reverted!! <br />If you wish to edit
            , go back to the previous page</h1>}

            <h1  className=" pt-14 text-white text-xl"><span className="opacity-85 text-purple-700">teamname:&nbsp;</span>{teamname}</h1>
                ...
                <div className=" mt-11 w-full grid grid-cols-1 lg:grid-cols-3 gap-5 ">
                    {
                        ...
                        key={member} className=" bg-slate-900 border-2 border-slate-800 p-8 col-span-1 rounded-lg shadow-xl">
                            ...
                            <div className=" w-full text-white font-sans flex items-center text-lg pt-3 border-t-2 border-purple-700"><span className=" opacity-85"> name: &nbsp;</span>  {member.name}
                            ...
                            <div className=" w-full text-white font-sans text-lg pt-3 pb-4 border-b-2 border-purple-700"><span className=" opacity-85">country:</span> {member.country}</div>
                        </div>)
                    }
                </div>
