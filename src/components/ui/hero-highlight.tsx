...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "relative py-14 pt-36 min-h-dvh flex items-center bg-black justify-center w-dvw group",
        containerClassName
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative text-4xl inline-block pb-1 w-fit px-2 py-2 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500`,
        className
      )}
    >
      {children}
